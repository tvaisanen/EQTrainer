...
const lowOrHigh = {
    ...
    filter: [],
    instructions: "In this exercise you have to recognize between low pass filter and high pass filter. " +
    "The cut off frequency is 1000 Hz.",
    answers: [
        {filter: 'lowpass', label: 'Lowpass', frequency: '1000', id: 'answer-0', gain: 1},
        {filter: 'highpass', label: 'Highpass', frequency: '1000', id: 'answer-1', gain: 1},
    ]
};
...
const midHighBandpass = {
    ...
    answers: [
        ...
        {filter: 'bandpass', label: '3.2 kHz', frequency: '3200', id: '3200', gain: 1, q: 1},
        {filter: 'bandpass', label: '6.4 kHz', frequency: '6400', id: '6400', gain: 1, q: 1},
        {filter: 'bandpass', label: '12 kHz', frequency: '12000', id: '12000', gain: 1, q: 1},
        {filter: 'bandpass', label: '16 kHz', frequency: '16000', id: '16000', gain: 1, q: 1},
    ]
};
...
const lowMidBandpass = {
    ...
    answers: [
        {filter: 'bandpass', label: '50 Hz', frequency: '50', id: '50', gain: 1, q: 1},
        {filter: 'bandpass', label: '100 Hz', frequency: '100', id: '100', gain: 1, q: 1},
        {filter: 'bandpass', label: '200 Hz', frequency: '200', id: '200', gain: 1, q: 1},
        {filter: 'bandpass', label: '400 Hz', frequency: '400', id: '400', gain: 1, q: 1},
        {filter: 'bandpass', label: '800 Hz', frequency: '800', id: '800', gain: 1, q: 1},
    ]
};
...
const lowshelfOrHighselfBoost = {
    ...
    answers: [
        {filter: 'lowshelf', label: 'Lowshelf 50 Hz', frequency: '50', id: '50', gain: 12, q: 1},
        {filter: 'lowshelf', label: 'Lowshelf 100 Hz', frequency: '100', id: '100', gain: 12, q: 1},
        {filter: 'lowshelf', label: 'Lowshelf 200 Hz', frequency: '200', id: '100', gain: 12, q: 1},
        {filter: 'highshelf', label: 'Highshelf 10 kHz', frequency: '10000', id: '200', gain: 12, q: 1},
        {filter: 'highshelf', label: 'Highshelf 12 kHz', frequency: '12000', id: '400', gain: 12, q: 1},
        {filter: 'highshelf', label: 'Highshelf 16 kHz', frequency: '16000', id: '800', gain: 12, q: 1},
    ]
};

const lowshelfOrHighselfAttenuation = {
    title: "Lowshelf or Highshelf Att.",
    filter: [],
        instructions: "Todo: Instructions",
...
export const exercises = [
    ...
    {params: lowshelfOrHighselfAttenuation, component: <LowshelfOrHighselfAttenuation exercise={lowshelfOrHighselfAttenuation}/>},
